...
export default function Login({ status, canResetPassword }: LoginProps) {
    ...
    const { fetchStore } = useContext(StoreDashboardAuthContext);
    ...
    const submit: FormEventHandler = (e) => {
        ...
        axiosClient.get('/sanctum/csrf-cookie').then(res => {
            axiosClient.post("store/login", loginData)
                .then(response => {
                    fetchStore();
        ...
        <AuthLayout title="Log in to your account" description="Enter your email and password below to log in">
            ...
            <form className="flex flex-col gap-6" onSubmit={submit}>
                <div className="grid gap-6">
                    ...
                    <div className="grid gap-2">
                        <div className="flex items-center">
                            ...
                            {canResetPassword && (
                                <TextLink to={'/store/forgot-password'} className="ml-auto text-sm" tabIndex={5}>
                                    Forgot password?
                                </TextLink>
                            )}
                        </div>
                ...
                <div className="text-muted-foreground text-center text-sm">
                    ...
                    <TextLink to={'/store/register'} tabIndex={5}>
                        Sign up
                    </TextLink>
                </div>
            </form>
